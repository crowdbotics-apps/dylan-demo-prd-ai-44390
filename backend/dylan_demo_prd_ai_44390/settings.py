"""
Django settings for dylan_demo_prd_ai_44390 project.
...
ROOT_URLCONF = 'dylan_demo_prd_ai_44390.urls'
...
WSGI_APPLICATION = 'dylan_demo_prd_ai_44390.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dylan_demo_prd_ai_44390 API",
    "DESCRIPTION": "API documentation for dylan_demo_prd_ai_44390 App",
    "VERSION": "v1",
}
